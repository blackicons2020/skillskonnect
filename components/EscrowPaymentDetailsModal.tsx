            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md transform transition-all">
                <div className="p-6 relative">
                    ...
                    <div className="text-center">
                        <h3 className="text-xl font-bold text-gray-900">Escrow Payment</h3>
                        <p className="mt-2 text-sm text-gray-500">Please make a payment of <span className="font-bold text-lg text-dark">₦{totalAmount.toLocaleString()}</span> to the account below.</p>
                    </div>
                    ...
                    <p className="text-xs text-center text-gray-500">After confirming, please upload your payment receipt from your dashboard to activate the booking.</p>

                    <div className="mt-6">
                        <button
                            onClick={() => onConfirmBooking('Escrow', cleaner)}
